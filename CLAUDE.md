...
| `dictionary/29_back_player_development.md` | バックプレーヤー育成メソッド（各国金脈） | ドイツAIM-Position・4択判断ツリー・バック-ピボット3概念（フェアラゲルン/シュペレン/アプゼッツェン）・フランスFIXATION DU DEMI-CENTRE・デンマーク序盤20分コーディング+50.2%デュアルバック・アイスランド80-100回1v1法・クロアチア踏み切りステップ数理論+フィート哲学・スペインDujshebaevスキャン-識別-コミット+統一術語（cruce/cortina/bloqueo）・GKキュー逆工学（PMC10591308） |
